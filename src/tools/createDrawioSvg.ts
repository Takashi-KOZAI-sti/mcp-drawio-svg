...
// Re-export schema constants so existing consumers can still import from here
export { NODE_STYLE_OVERRIDES_SCHEMA, EDGE_STYLE_OVERRIDES_SCHEMA, GROUP_STYLE_OVERRIDES_SCHEMA };
